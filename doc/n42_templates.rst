...
The vast majority of replay tools ingest spectra formatted to the N42.42 ANSI standard.
Manufacturers vary in the exact N42 content they produce, and replay tools often require
that specific format and content. To handle different .n42 variants, RASE uses a Mako_-
based templating system that replaces template blocks with the specific content created
during the sample generation
step.

The following table lists the basic variables available for use in a template
file:
